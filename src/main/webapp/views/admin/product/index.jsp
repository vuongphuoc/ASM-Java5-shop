...
<main style="margin-top: 50px">
    ...
    <div class="row mt-2 mb-4">
        <div class="col-7 p-0">
            <form action="/admin/product/searchTen" method="get">
            <div class="header__search">
                <input  name="name" value="${param.ten}" placeholder="Tìm kiếm" class="header__input">
               <button type="submit"> <i class='bx bx-search header__icon mt-1'></i></button>
            </div>
            </form>
            <div class="header__toggle">
                <i class='bx bx-menu' id="header-toggle"></i>
